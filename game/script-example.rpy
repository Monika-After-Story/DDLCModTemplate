...
label example_chapter:
    ...
    m 4i "Of course, if you really want to dig deep and change how the game works..."
    ...
    #We reset the pose here, because the choice function does not allow inline changes in the first line.
    ...
    menu:
        ...
        "I'm an experienced coder":
            $experience_level = 2
            m 1b "Really? That's very impressive!"
            m 5 "I'm new to this, myself, so maybe I'll end up learning more from you, instead!"
        "I've coded before":
            $experience_level = 1
            m 1a "That's good."
        ...
        "New to coding":
            $experience_level = 0
            m 1k "Really? This should be fun then!"
            m 1f "I'm pretty new to this myself..."
            m 1g "So it's a little a weird for me to be someone's teacher."
        ...
        menu:
            ...
            "Yes.":
                ...
                if not knows_renpy:
                    ...
                    m 1k "Sounds like you're in great shape for this!"
                    m 1j "You have all the skills you need to make whatever you want."
                    m 5 "I'm excited to see what you come up with."
            "No.":
                if not knows_renpy:
    ...
    menu:
        ...
        "Basic.":
            $advanced = False
            m 1a "Starting off with something simple?"
        ...
        "Advanced.":
            $advanced = True
            m 1d "Trying for something a little more complicated?"
